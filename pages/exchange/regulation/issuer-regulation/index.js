...
import SECTIONS from '../../../../layouts/exchange/regulation/issuer-regulation/sections';
...
export class IssuerRegulation extends Component {
  render() {
    return (
        <main>
          <div className={helpers.allowForPageNav}>
            <Jumbotron title="Issuer Regulation" />
          </div>
...
export default IssuerRegulation;
